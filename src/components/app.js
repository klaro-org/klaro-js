...
export default class App extends React.Component {
    ...
    render() {
        const {config, t, manager, wiggle, stylePrefix} = this.props
        ...
        return (
            <div className={stylePrefix}>
                <ConsentNotice wiggle={wiggle} key={"app-"+this.props.show} t={t} show={show} hide={hide} config={config} manager={manager} />
            </div>
        )
    }
}
